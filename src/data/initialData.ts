...
export const INITIAL_COURSES: Course[] = [
  ...
  {
    id: "ict-kids",
    title: "التكنولوجيا (ICT)",
    category: "ict",
    shortDescription: "مادة تقنية عملية للطلاب من الصف الرابع الابتدائي إلى الصف الثالث الإعدادي، مع محتوى عربي مبسط يركز على المهارات الرقمية الأساسية.",
    fullDescription: "مادة التكنولوجيا (ICT) موجهة للطلاب من الصف الرابع الابتدائي حتى الصف الثالث الإعدادي، وتُقدَّم بشكل عملي ومبسط لتطوير المهارات الرقمية الأساسية مثل استخدام الحاسوب، الإنترنت، التطبيقات التعليمية، ومعالجة المعلومات بطريقة آمنة ومناسبة لعمر الطالب. تُدرَّس المادة باللغة العربية، مع التركيز على تعزيز التفكير المنطقي والتقنية في حياة الطالب اليومية.",
    image: "https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&q=80&w=800",
    ageGroup: "من الصف الرابع الابتدائي إلى الصف الثالث الإعدادي",
    duration: "سنة دراسية",
    sessionsCount: "حسب الخطة المدرسية",
    badge: "مادة مدرسية معتمدة",
    popular: true,
    stage: "من الصف الرابع الابتدائي إلى الصف الثالث الإعدادي",
    language: "عربي",
    levels: ["الصف الرابع الابتدائي", "الصف الخامس الابتدائي", "الصف السادس الابتدائي", "الصف الأول الإعدادي", "الصف الثاني الإعدادي", "الصف الثالث الإعدادي"],
    features: [
      "تعلم أساسيات الحاسوب والإنترنت",
      "استخدام التطبيقات التعليمية والتقنيات الرقمية",
      "تنمية مهارات البحث والتعامل مع المعلومات",
      "التوعية بالسلامة الرقمية والاستخدام الآمن"
    ],
    skillsLearned: [
      "مهارات استخدام الحاسوب",
      "التعامل مع الإنترنت والتطبيقات التعليمية",
      "البحث عن المعلومات بشكل منظم",
